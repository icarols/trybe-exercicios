...
//listar os valores de cada chave do nosso objeto usando for in @@@---!!!---@@@
const coolestTvShow = {
  name: "BoJack Horseman",
  genre: "adult animation",
  createdBy: "Raphael Bob-Waksberg",
...
//listar os valores de cada chave do nosso objeto usando Object.values @@@---!!!---@@@
const student = {
  Html: 'Muito Bom',
  Css: 'Bom',
  JavaScript: 'Ótimo',
...
//usando o Object.entries para retornar um array de arrays, onde a primeira posição é a chave e a segunda o valor da chave @@@---!!!---@@@
const países = {
  França: 'Paris',
  Brasil: 'Brasília',
  Espanha: 'Madrid',
...
//usando Object.assign para copiar/clonar proprieadades de um objeto para outro modificando os dois ao mesmo tempo @@@---!!!---@@@
const person = {
  name: 'Roberto',
};
...
//usando Object.assign para copiar proprieadades de um objeto para outro novo @@@---!!!---@@@
const person = {
  name: 'Roberto',
};
